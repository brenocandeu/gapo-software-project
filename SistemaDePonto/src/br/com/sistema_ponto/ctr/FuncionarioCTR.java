...
public class FuncionarioCTR {
    ...
    public String inserirFuncionario(FuncionariosDTO funcionariosDTO, EmpresaDTO empresaDTO, HorarioDTO horarioDTO) {
        try {
            if (funcionariosDAO.inserirFuncionarios(funcionariosDTO, empresaDTO, horarioDTO)) {
    ...
    public String alterarFuncionarios(FuncionariosDTO funcionariosDTO, EmpresaDTO empresaDTO, HorarioDTO horarioDTO){
        try{
            if(funcionariosDAO.alterarFuncionarios(funcionariosDTO, empresaDTO, horarioDTO)){
