...
//    public String logarUsuario(UsuarioDTO usuarioDTO) {
//        try {
//            ConexaoDAO.ConectDB();
//            stmt = ConexaoDAO.con.createStatement();
//            
//            String comando = "Select f.tipo_user " +
//                             "from usuario f " +
//                             "where f.login_user = '" + usuarioDTO.getLogin_user() + "'" +
//                             "and f.senha_user = '" + criptografar(usuarioDTO.getSenha_user()) + "'";
//            
//            rs = null;
