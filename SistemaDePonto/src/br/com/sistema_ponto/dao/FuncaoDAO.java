...
public class FuncaoDAO {
    ...
    public ResultSet consultarFuncao(FuncaoDTO funcaoDTO, int opcao){
        ...
        try {
            ...
            switch(opcao) {
                case 1:
                    comando = "SELECT f.* FROM funcao f WHERE nome_funcao LIKE '" + funcaoDTO.getNome_funcao() + "%' ORDER BY f.nome_funcao";
                    break;
                case 2:
                    comando = "SELECT f.* FROM funcao f WHERE f.id_funcao = " + funcaoDTO.getId_funcao();
                    break;
                case 3:
                    comando = "SELECT f.id_funcao, f.nome_funcao FROM funcao f";
                    break;
            }
