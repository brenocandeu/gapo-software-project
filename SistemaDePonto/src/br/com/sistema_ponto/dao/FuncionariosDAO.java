...
public class FuncionariosDAO {
    ...
    public boolean inserirFuncionarios(FuncionariosDTO funcionariosDTO, EmpresaDTO empresaDTO, HorarioDTO horarioDTO){
        try{        
            ConexaoDAO.ConectDB();
            stmt = ConexaoDAO.con.createStatement();

            String comando = "INSERT INTO funcionarios (n_folha, nome_funcionario, n_pis, n_identificador, n_ctps, id_horario, admissao_funcionarios, demissao_funcionarios, id_empresa) VALUES ("
...
//                    + "'" + funcionariosDTO.getFuncao_funcionarios() + "', "
//                    + "'" + funcionariosDTO.getDepartamento_funcionarios() + "', "
    ...
    public boolean alterarFuncionarios(FuncionariosDTO funcionariosDTO, EmpresaDTO empresaDTO, HorarioDTO horarioDTO){
        try{
            ConexaoDAO.ConectDB();
            stmt = ConexaoDAO.con.createStatement();
