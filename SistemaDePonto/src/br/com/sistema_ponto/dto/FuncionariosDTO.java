...
public class FuncionariosDTO {
   private  String nome_funcionario, n_ctps, empresa_funcionarios, funcao_funcionarios, departamento_funcionarios;
   private Date admissao_funcionarios, demissao_funcionarios;
   private int id_funcionario, n_folha, n_pis, n_identificador, horario_funcionarios;
    ...
    public void setN_pis(int n_pis) {
        this.n_pis = n_pis;
    }
