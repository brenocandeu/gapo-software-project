...
public class CadastroFuncionariosVIEW extends javax.swing.JInternalFrame {
    ...
    private void preencheEmpresaBox(String nome_empresa, int idFuncionario) {
        ...
        try {
            ...
            EmpresaDTO empresaDTO = new EmpresaDTO();
            empresaDTO.setNome_empresa(nome_empresa); // Se não usa filtro, inicialize com dados default

            // Consulta para obter a lista de empresas
            rsEmpresas = empresaCTR.consultarEmpresa(empresaDTO, 1);
            while (rsEmpresas.next()) {
                EmpresaDTO empresa = new EmpresaDTO(); // Cria uma nova instância de EmpresaDTO a cada iteração
    ...
    private void preencheHorarioBox(String descricao_horario, int idFuncionario) {
        ...
        try {
            ...
            HorarioDTO horarioDTO = new HorarioDTO();
            horarioDTO.setDescricaoHorario(descricao_horario); // Se não usa filtro, inicialize com dados default

            // Consulta para obter a lista de horários
            rsHorarios = horarioCTR.consultarHorario(horarioDTO, 1);
            while (rsHorarios.next()) {
                HorarioDTO horario = new HorarioDTO(); // Cria uma nova instância de HorarioDTO a cada iteração
    ...
    private void gravar(){
        try{
            ...
            funcionariosDTO.setN_pis(Integer.parseInt(n_pis_funcionarios.getText()));
            ...
            //funcionariosDTO.setFuncao_funcionarios(funcao_funcionarios.getSelectedItem().toString());
            ...
            JOptionPane.showMessageDialog(null, funcionarioCTR.inserirFuncionario(funcionariosDTO, empresaDTO, horarioDTO));
        }
        catch (Exception e){
    ...
    public void preencherCampos(int idFuncionario){
        try{
            ...
            if(rs.next()){
                ...
                //funcao_funcionarios.setSelectedItem(rs.getString("funcao_funcionarios"));
    ...
    private void alterarFuncionario(){
        try{
            ...
            JOptionPane.showMessageDialog(null, funcionarioCTR.alterarFuncionarios(funcionariosDTO, empresaDTO, horarioDTO));
        }
        catch (Exception e){
    ...
    private void initComponents() {
        ...
        n_pis_funcionarios = new javax.swing.JTextField();
        ...
        n_pis_funcionarios.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                n_pis_funcionariosActionPerformed(evt);
            }
        });
        ...
        funcao_funcionarios.setEditable(true);
                        ...
                        .addGroup(jPanel2Layout.createSequentialGroup()
                            ...
                            .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                                    .addComponent(n_pis_funcionarios, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 145, Short.MAX_VALUE)
                                    .addComponent(n_identificador_funcionarios, javax.swing.GroupLayout.Alignment.LEADING))
    ...
    private void n_pis_funcionariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_n_pis_funcionariosActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_n_pis_funcionariosActionPerformed
    ...
    private javax.swing.JTextField n_pis_funcionarios;
